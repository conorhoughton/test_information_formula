...
\title[A Kozachenko-Leonenko estimator.]{Mutual information for functions, maybe even ERPs.}
...
$$I(X,Y)=\frac{1}{n}\sum_{y_i}\log_2{\frac{n\#_{y_i}B}{h}}$$ where
...
$$I(X,Y)=\frac{1}{n}\sum_{y_i}\log_2{\frac{n_s\#_{y_i}B}{h}}$$
\begin{center}
